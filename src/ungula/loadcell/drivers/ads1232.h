...
namespace ungula::loadcell
{
    ...
    public:
        ...
        bool begin(uint8_t doutPin, uint8_t sclkPin, uint8_t pdwnPin = GPIO_NONE, uint8_t speedPin = GPIO_NONE,
                   uint8_t a0Pin = GPIO_NONE, uint8_t gain0Pin = GPIO_NONE, uint8_t gain1Pin = GPIO_NONE,
